...
export default class SiteVisitor extends Component {
  ...
  onSubmit(e) {
    ...
    axios
      .post(
        "https://portfolio-backend-kimonic99.vercel.app/visitors/create-visitor",
        visitorObject
      )
      .then(() =>
        axios
          .get("https://portfolio-backend-kimonic99.vercel.app/visitors")
          .then((res) => {
            this.setState({
              visitors: res.data,
            });
    ...
    return (
      <main className="flex-grow m-2 md:m-4 lg:pb-4">
        ...
        <p className="text-2xl md:text-3xl font-light mb-5 md:mb-10 text-center">
          Add your info and I'll reach out.
        </p>
